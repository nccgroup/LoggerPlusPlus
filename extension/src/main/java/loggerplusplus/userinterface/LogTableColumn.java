...
public class LogTableColumn extends TableColumn implements Comparable<LogTableColumn>{
    ...
    public enum ColumnIdentifier {
        ...
        SENTCOOKIES, USESCOOKIEJAR, REQUEST, RESPONSE, REQUESTHEADERS, RESPONSEHEADERS,
		REGEX1REQ, REGEX2REQ, REGEX3REQ, REGEX4REQ, REGEX5REQ, REGEX1RESP,
		REGEX2RESP, REGEX3RESP, REGEX4RESP, REGEX5RESP,
    }
