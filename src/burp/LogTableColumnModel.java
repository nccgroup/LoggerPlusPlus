...
public class LogTableColumnModel extends DefaultTableColumnModel {
	private final String defaultLogTableColumnsJson = "["
			...
			+ "{'id':4,'name':'Url','enabled':true,'defaultVisibleName':'URL','visibleName':'URL','preferredWidth':250,'type':'string','readonly':true,'order':5,'visible':false,'description':'Destination relative URL','isRegEx':false,'regExString':'','regExCaseSensitive':false},"
