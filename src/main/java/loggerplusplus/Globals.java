...
//            + "{'id':" + HOST + ",'index':" + (colModelIndex++) + ",'name':'Host','defaultVisibleName':'Host','visibleName':'Host','preferredWidth':150,'type':'string','readonly':true,'order':" + colOrder++ + ",'visible':true,'description':'Host and Protocol (similar to the ProxyFieldProvider tab)','isRegEx':false,'regExString':'','regExCaseSensitive':false},"
...
//            + "{'id':" + LISTENERINTERFACE + ",'index':" + (colModelIndex++) + ",'name':'ListenerInterface','defaultVisibleName':'ProxyFieldProvider Listener Interface','visibleName':'ProxyFieldProvider Listener Interface','preferredWidth':150,'type':'string','readonly':true,'order':" + colOrder++ + ",'visible':true,'description':'Shows the proxy listener interface for proxied requests','isRegEx':false,'regExString':'','regExCaseSensitive':false},"
//            + "{'id':" + CLIENTIP + ",'index':" + (colModelIndex++) + ",'name':'ClientIP','defaultVisibleName':'ProxyFieldProvider Client IP','visibleName':'ProxyFieldProvider Client IP','preferredWidth':150,'type':'string','readonly':true,'order':" + colOrder++ + ",'visible':false,'description':'Shows the client IP address when using the ProxyFieldProvider tab','isRegEx':false,'regExString':'','regExCaseSensitive':false},"
