...
import static loggerplusplus.LogEntryField.*;
...
public class Globals {
    ...
    public static final String DEFAULT_LOG_TABLE_COLUMNS_JSON = "["
            ...
            + "{'id':" + USES_COOKIE_JAR + ",'index':" + (colModelIndex++) + ",'name':'UsesCookieJar','defaultVisibleName':'Contains cookie jar?','visibleName':'Contains cookie jar?','preferredWidth':150,'type':'string','readonly':true,'order':" + colOrder++ + ",'visible':false,'description':'Compares the cookies with the cookie jar ones to see if any of them in use','isRegEx':false,'regExString':'','regExCaseSensitive':false},"
