...
{if (true) throw new ParseException("Unbalanced brackets.");}
  ...
  final public LogicalOperator ExpressionCompounding() throws ParseException {LogicalOperator op;
...
//To make interpretation easier, we convert (Value) to (Value operation value) by means of (Value EQUALS TRUE)
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);BooleanOperator op = BooleanOperator.EQUAL;
...
//TYPES
  final public Date Date() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OPEN_SINGLE_QUOTE_STRING:{
...
try{
            Date date = LogManager.sdf.parse(t.image);
            {if ("" != null) return date;}
        }catch (Exception e){
  ...
  final public BigDecimal Number() throws ParseException {Token t;
...
{if ("" != null) return (inverse != null ^ java.lang.Boolean.parseBoolean(t.image));}
    throw new Error("Missing return statement in function");
}
...
//BASIC OPERATORS
  final public 
BooleanOperator EqualityOperator() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EQ:{
      jj_consume_token(EQ);
{if ("" != null) return BooleanOperator.EQUAL;}
      break;
      }
    case NEQ:{
      jj_consume_token(NEQ);
{if ("" != null) return BooleanOperator.NOT_EQUAL;}
      break;
      }
    default:
      jj_la1[27] = jj_gen;
  ...
  final public BooleanOperator NumericOperator() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case GT:{
      jj_consume_token(GT);
{if ("" != null) return BooleanOperator.GREATER_THAN;}
      break;
      }
    case LT:{
      jj_consume_token(LT);
{if ("" != null) return BooleanOperator.LESS_THAN;}
      break;
      }
    case GEQ:{
      jj_consume_token(GEQ);
{if ("" != null) return BooleanOperator.GREATER_THAN_EQUAL;}
      break;
      }
    case LEQ:{
      jj_consume_token(LEQ);
{if ("" != null) return BooleanOperator.LESS_THAN_EQUAL;}
      break;
      }
    default:
      jj_la1[28] = jj_gen;
  ...
  final public BooleanOperator ContainsOperator() throws ParseException {
    jj_consume_token(CONTAINS);
{if ("" != null) return BooleanOperator.CONTAINS;}
    throw new Error("Missing return statement in function");
}

  final public BooleanOperator MatchesOperator() throws ParseException {
    jj_consume_token(MATCHES);
{if ("" != null) return BooleanOperator.MATCHES;}
    throw new Error("Missing return statement in function");
}

  final public BooleanOperator InOperator() throws ParseException {
    jj_consume_token(IN);
{if ("" != null) return BooleanOperator.IN;}
    throw new Error("Missing return statement in function");
}
