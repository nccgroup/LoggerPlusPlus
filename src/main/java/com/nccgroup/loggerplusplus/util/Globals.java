...
public class Globals {
    ...
    public static final String DEFAULT_LOG_TABLE_COLUMNS_JSON = new StringBuilder().append("[")
            ...
            .append("{'id':" + PATHQUERY + ",'name':'Path Query','defaultVisibleName':'Path Query','visibleName':'Path Query','preferredWidth':250,'readonly':true,'order':" + colOrder++ + ",'visible':true,'description':'" + StringEscapeUtils.escapeJson(PATHQUERY.getDescription()) + "'},")
